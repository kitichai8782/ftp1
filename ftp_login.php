...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($condb, "SELECT * FROM tb_account WHERE ac_username = '$username' AND ac_password = '$password' ");
        ...
        if(mysqli_num_rows($result)){
            ...
            $_SESSION['ftp_username'] = $result['ac_username'];
            $_SESSION['ftp_password'] = $_POST['password'];
            $_SESSION['ftp_status'] = $result['ac_status'];
